...
namespace ARLocation
{
    ...
    public class ARLocationProvider : Singleton<ARLocationProvider>
    {
        ...
        public override void Awake()
        {
            ...
            {
                // Default to PIEAS Campus if no MockLocationData is assigned
                Logger.LogFromMethod("ARLocationProvider", "Awake", "No MockLocationData assigned. Using default PIEAS Campus location.", DebugMode);
                ((MockLocationProvider) Provider).mockLocation = new Location 
                { 
